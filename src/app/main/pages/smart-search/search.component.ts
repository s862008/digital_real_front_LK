  ...
  public searching(): void {
    ...
    if (this.smartParameters) {
      ...
      const toSearch: SmartSearch = {
        ...
        apartmentTypeWeight: SearchComponent.getWeight(this.smartParameters.apartmentTypeWeight),

        numberOfRooms: this.getQuantityRooms(),
        numberOfRoomsWeight: SearchComponent.getWeight(this.smartParameters.numberOfRoomsWeight),
        ...
        priceWeight: SearchComponent.getWeight(this.smartParameters.priceWeight),

        floor: this.getTriangle(this.smartParameters.floorMin, this.smartParameters.floorPreference, this.smartParameters.floorMax),
        floorWeight: SearchComponent.getWeight(this.smartParameters.floorWeight),
        ...
        countFloorWeight: SearchComponent.getWeight(this.smartParameters.countFloorWeight),
        ...
        viewFromWindowsWeight: SearchComponent.getWeight(this.smartParameters.viewFromWindowsWeight),

        balcony: this.getBalcony(),
        balconyWeight: SearchComponent.getWeight(this.smartParameters.balconyWeight),

        bathroom: this.getBathroom(),
        bathroomWeight: SearchComponent.getWeight(this.smartParameters.bathroomWeight),

        isElectricStove: this.smartParameters.isElectricStove,
        isGasStove: this.smartParameters.isGasStove,
        stoveWeight: SearchComponent.getWeight(this.smartParameters.stoveWeight),

        decoration: this.getDecoration(),
        decorationWeight: SearchComponent.getWeight(this.smartParameters.decorationWeight),
        ...
        numberOfApartmentsWeight: SearchComponent.getWeight(this.smartParameters.numberOfApartmentsWeight),
        ...
        areaPriceWeight: SearchComponent.getWeight(this.smartParameters.areaPriceWeight),

        decorationWall: this.getDecorationWall(),
        decorationWallWeight: SearchComponent.getWeight(this.smartParameters.decorationWallWeight),

        decorationCeiling: this.getDecorationCeiling(),
        decorationCeilingWeight: SearchComponent.getWeight(this.smartParameters.decorationCeilingWeight),

        floorCovering: this.getFloorCovering(),
        floorCoveringWeight: SearchComponent.getWeight(this.smartParameters.floorCoveringWeight),

        repairType: this.getRepairType(),
        repairTypeWeight: SearchComponent.getWeight(this.smartParameters.repairTypeWeight),

        glazing: this.getGlazing(),
        glazingWeight: SearchComponent.getWeight(this.smartParameters.glazingWeight),

        isWithoutDecBathroom: this.smartParameters.isWithoutDecBathroom,
        isWithDecBathroom: this.smartParameters.isWithDecBathroom,
        decorationBathroomWeight: SearchComponent.getWeight(this.smartParameters.decorationBathroomWeight),

        radiators: this.getRadiators(),
        radiatorsWeight: SearchComponent.getWeight(this.smartParameters.radiatorsWeight),

        houseType: this.getBuilds(),
        houseTypeWeight: SearchComponent.getWeight(this.smartParameters.buildWeight),

        dClass: this.getClass(),
        dClassWeight: SearchComponent.getWeight(this.smartParameters.classWeight),

        asesmic: this.getAsesmic(),
        asesmicWeight: SearchComponent.getWeight(this.smartParameters.asesmicWeight),
        ...
        ceilingHeightWeight: SearchComponent.getWeight(this.smartParameters.ceilingHeightWeight),

        numberElevators: this.getNumberElevators(),
        numberElevatorsWeight: SearchComponent.getWeight(this.smartParameters.numberElevatorsWeight),

        smartHome: this.getSwitch([this.smartParameters.isSmart, this.smartParameters.isNotSmart]),
        smartHomeWeight: SearchComponent.getWeight(this.smartParameters.smartHomeWeight),
        ...
        elevatorTypeWeight: SearchComponent.getWeight(this.smartParameters.elevatorTypeWeight),

        selfBoiler: this.getSwitch([this.smartParameters.isSelfBoiler, this.smartParameters.isNoSelfBoiler]),
        selfBoilerWeight: SearchComponent.getWeight(this.smartParameters.selfBoilerWeight),

        nearby: this.getNearby(),
        nearbyWeight: SearchComponent.getWeight(this.smartParameters.nearbyWeight),

        parking: this.getParking(),
        parkingWeight: SearchComponent.getWeight(this.smartParameters.parkingWeight),

        closedYard: this.getSwitch([this.smartParameters.isClosedYard, this.smartParameters.isNoClosedYard]),
        closedYardWeight: SearchComponent.getWeight(this.smartParameters.closedYardWeight),
        ...
        furnitureWeight: SearchComponent.getWeight(this.smartParameters.furnitureWeight),
